...
#Plotting Odds Ratios
plot_model(slr_clean,sort.est = TRUE,grid = TRUE,title = 'Odds Ratio for Explanitory Variables: SLR')
```

```{r Compare Clean Simple to Unclean Simple}

anova(slr_fsr,slr, test = "Chisq",class(relaxed_cv_model))
...
anova(slr_clean,relaxed_cv_model, test = "Chisq",class(relaxed_cv_model))
