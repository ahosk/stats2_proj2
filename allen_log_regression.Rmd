...
relaxed_best_lambda
#plot cv model
plot(relaxed_cv_model,se.bands = FALSE)



#lasso model
relaxed_best_model = glmnet(train_expl,train_resp, lambda = relaxed_best_lambda,family = 'binomial',relax = TRUE)
...
#assess lasso model
assess.glmnet(relaxed_cv_model,test_expl,test_resp, family = 'binomial',s = relaxed_best_lambda,relax = TRUE)
#return confusion matrix from lasso model
confusion.glmnet(relaxed_cv_model,test_expl,test_resp,family = 'binomial',s=relaxed_best_lambda,relax = TRUE)
#plot roc curve from lasso model
plot(roc.glmnet(relaxed_cv_model,test_expl,test_resp,family = 'binomial',s=relaxed_best_lambda,relax = TRUE))
