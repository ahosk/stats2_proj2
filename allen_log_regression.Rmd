...
lasso_train_expl = data.matrix(train_df[,c(3,4,6,7,8,9,12,13,14,15)])
lasso_test_expl = data.matrix(test_df[,c(3,4,6,7,8,9,12,13,14,15)])

rlasso_cv_model = glmnet(lasso_train_expl,train_resp,family = 'binomial',s = relaxed_best_lambda)
plot(rlasso_cv_model, label = TRUE)
